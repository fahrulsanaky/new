...
export default function MainSection() {
  return (
    <section id="mainSection" className="w-full h-auto bg-white flex items-center justify-center py-16 px-[32px]">
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-10 lg:gap-12">
        {/* Row Atas: 2 Kolom (Konten Kiri & Gambar Kanan) */}
        <div className="w-full flex flex-col lg:flex-row items-stretch justify-between gap-8 lg:gap-12 px-[32px]">
          {/* Kolom Kiri: Deskripsi In-House Training */}
          <div
          ...
          >
            ...
            <div className="mb-3 flex items-center justify-start gap-2.5">
              <span
                ...
                style={{ color: '#1cd690' }}
              >
                <Building2 size={28} className="text-[#1cd690]" color="#1cd690" />
              </span>
              <span
            ...
            <h2
              ...
              className="text-[28px] sm:text-[32px] font-bold text-[#022859] leading-[36px] sm:leading-[40px] tracking-tight mb-4"
            >
          ...
          {/* Kolom Kanan: Gambar dengan Lebar 45% dan Radius 16px */}
          <div
            id="inhouse-training-right-image-wrapper"
            className="w-full lg:w-[45%] rounded-[16px] overflow-hidden shadow-sm bg-slate-100 self-center h-[280px] sm:h-[340px] lg:h-[360px]"
          >
            <img
